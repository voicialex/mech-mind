...
CameraManager::CameraManager() {
  ...
  if (ConfigHelper::getInstance().render_config_.enable) {
    display_window_ = std::make_unique<CVWindow>(ConfigHelper::getInstance().render_config_.window_title, ConfigHelper::getInstance().render_config_.window_width,
...
void CameraManager::ShowImages(FrameSet &frame) {
  // Display images
  if (display_window_ && ConfigHelper::getInstance().render_config_.enable && frame.hasColor && frame.hasDepth) {
